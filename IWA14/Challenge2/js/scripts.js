...
const add = (a, b) =>  a + b //Function that takes two parameters 'a' and 'b' and added return so it returns their sum.
...
function internal() {
	...
	console.log(multiply)//change 'return this' to console so it print results of multipl
}
