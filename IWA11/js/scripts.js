//selecting the first order's data list and its different items.
...
//Updating the values of the first order's items and status in the dataset.
...
status1.textContent = root1.dataset.delivered === "true" ? "Delivered" : "Pending";//used tenery to get the status value

//selecting the second order's data list and its different items.
...
//Updating the values of the second order's items and status in the dataset.
...
//selecting the third order's data list and its different items.
...
//Updating the values of the third order's items and status in the dataset.
